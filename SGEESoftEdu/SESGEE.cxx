...
SGIntegratedGUI::SGIntegratedGUI(const TGWindow *p, UInt_t w, UInt_t h) : TGMainFrame(p, w, h) {
    ...
    picSGEE     = LoadAndScaleImage(workDir + "/icons/logoSGEE.png", "picSGEE_scaled", 45);
    picFisinfor = LoadAndScaleImage(workDir + "/icons/logoFisinfor_v2.png", "picFis_scaled", 35);
    picLIFAE    = LoadAndScaleImage(workDir + "/icons/logoLIFAE.png", "picLif_scaled", 35);
    picUD       = LoadAndScaleImage(workDir + "/icons/logoUD.png", "picUD_scaled", 45);
...
void SGIntegratedGUI::MostrarPortada() {
    ...
    // =========================================================
    TString pathLogo = gSystem->pwd();
    pathLogo += "/icons/logoUD.png";
